# tests/test_03_control_flow/test_task16_city_growth.py
"""
Тесты для задания 16: Моделирование роста города с ограничениями
"""

from tests.test_03_control_flow.conftest import run_student_code, get_module05_file


class TestTask16CityGrowth:
    """Тесты для задания 16: Моделирование роста города с ограничениями"""

    student_file = get_module05_file('task16_city_growth.py')
