...
"""
values = {'кг': 1, 'г' :0.001, 'фунт': 0.40951241, 'пуд': 16, 'ц': 100, 'т': 1000}
req = input("Введите вес и единицу измерения (напрмиер, '10 кг'): ").split()
num, typ = float(req[0]), req[1]
print(f'{num} {typ} = {num * values[typ]:.6f} кг')
