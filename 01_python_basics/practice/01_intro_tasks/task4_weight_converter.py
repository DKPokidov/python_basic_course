...
if bukva == 'кг':
    ...
    print(f'{float(weight)} г = {float(weight) * 10**-3} кг')
elif bukva == 'пуд':
    print(f'{float(weight)} пуд = {float(weight) * 16} кг')
elif bukva =='фунт':
    print(f'{float(weight)} фунт = {float(weight) * 0.40951241} кг')
elif bukva == 'ц':
    print(f'{float(weight)} ц = {float(weight) * 100} кг')
elif bukva == 'т':
    print(f'{float(weight)} т = {float(weight) * 1000} кг')