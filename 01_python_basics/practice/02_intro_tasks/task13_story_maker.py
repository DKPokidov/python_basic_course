...
elements = []
universal = ["имя: ", "любимая еда: ", "профессия: ", "навык: ", "город: ", "персонаж: ", "фраза персонажа: ", "ответ хомяка: ", \
             "прилагательное: "]
for i in universal:
...
f"{elements[7]} — и с тех пор {elements[0]} стал самым {elements[8]} хомяком в мире!"]
for i in d:
    print(i)